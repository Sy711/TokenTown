  ...
  return (
    <div className="w-full">
      <div className="mb-4 text-center">
        <h2 className="text-2xl font-bold text-white">TokenTown Leaderboard</h2>
        <p className="mt-1 text-gray-300">Current Vault: {vaultAmount} SUI</p>
      </div>

      <Card className="w-full bg-black/20 p-4">
        <h3 className="text-xl font-bold text-white mb-4 text-center">Today's Ranking</h3>
            ...
            <div className="mb-4 rounded-lg bg-blue-900/20 p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-300">Limit: 5 players</span>
                </div>
              </div>
            </div>
